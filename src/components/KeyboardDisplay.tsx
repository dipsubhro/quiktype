const Key = ({
  ...
  const colorStyle = isActive
    ...
    : "bg-card text-muted-foreground border-border hover:bg-accent hover:text-accent-foreground cursor-pointer";
...
const KeyboardDisplay = ({ activeKey }: { activeKey: string | null }) => {
  ...
  return (
    <div className="p-3 rounded-lg bg-card border border-border shadow-lg mt-8 max-w-md mx-auto">
